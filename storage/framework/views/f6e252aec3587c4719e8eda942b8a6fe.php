            ...
            <div  class="modal-c-tabs">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade in show active" id="panel17" role="tabpanel">
                        ...
                        <form  method="POST" action="<?php echo e(route('admin.menu.update',$val->id)); ?>"  enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="modal-body mb-1">
                                <div class="modal-body mb-1">
                                    ...
                                    <div class="md-form mb-2">
                                        ...
                                        <input value="<?php echo e($val->sort); ?>" id="sort" type="number" class="form-control" name="sort" >
                                    </div>
...
<!-- Modal: edit Form Demo -->
<?php /**PATH C:\xampp\htdocs\Analyzoor\resources\views/admin/menu/edit.blade.php ENDPATH**/ ?>