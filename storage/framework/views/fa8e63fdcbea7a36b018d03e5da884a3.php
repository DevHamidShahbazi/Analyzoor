    ...
    <div class="container">
        <div class="row m-0">
            ...
            <div class="col-lg-6 text-center" data-aos="zoom-out" data-aos-delay="200">
                <img src="<?php echo e($image); ?>" class="col-lg-10 col-md-8 col-12 my-5 animated" alt="logo">
            </div>
...
<?php /**PATH C:\xampp8.1\htdocs\Analyzoor\resources\views/components/public-slider/index.blade.php ENDPATH**/ ?>