    ...
    <div class="sidebar-wrapper royal-dark active">
        <div class="sidebar-header position-relative">
            ...
            <div class="d-flex justify-content-center align-items-center">
                <div class="logo">
                    <a class="col-6" href="<?php echo e(route('Home')); ?>"><img class="col-12" src="<?php echo e(setting_with_key('logo')->value); ?>" alt="<?php echo e(setting_with_key('logo_alt')->value); ?>" srcset=""></a>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\Analyzoor\resources\views/layouts/layout public/sidebar.blade.php ENDPATH**/ ?>