            ...
            <div class="col-lg-8">
                <div class="card shadow rounded-2 mb-4">
                    <div class="card-body p-4">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <img src="<?php echo e($course->image); ?>" alt="<?php echo e($course->alt); ?>" class="img-fluid rounded" style="width: 100%; height: 200px; object-fit: cover;">
                            </div>
                            <div class="col-md-8">
                                <h5 class="font-weight-bold mb-3"><?php echo e($course->name); ?></h5>
                                <p class="text-muted mb-3"><?php echo e($course->paragraph); ?></p>
                                
                                <div class="row">
                                    <div class="col-6">
                                        <div class="d-flex align-items-center mb-2">
                                            <span>دسته بندی: <?php echo e($course->category->name); ?></span>
                                            <i class="fas fa-folder text-primary mr-2"></i>
                                        </div>
                                        <div class="d-flex align-items-center mb-2">
                                            <span>وضعیت: <?php echo e(array_search($course->status, config('static_array.courseStatus'))); ?></span>
                                            <i class="fas fa-clock text-primary mr-2"></i>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="d-flex align-items-center mb-2">
                                            <span>تعداد جلسات: <?php echo e($course->episodes()->count()); ?></span>
                                            <i class="fas fa-play-circle text-primary mr-2"></i>
                                        </div>
                                        <div class="d-flex align-items-center mb-2">
                                            <span>نوع: <?php echo e(array_search($course->type, config('static_array.courseType'))); ?></span>
                                        ...
                                        <div class="price-display">
                                            <?php if($course->discount != null): ?>
                                                <div class="text-muted">
                                                    <strike><?php echo e(number_format($course->price)); ?> تومان</strike>
                                                </div>
                                            <?php endif; ?>
                                            <div class="text-primary font-weight-bold" style="font-size: 1.2rem;">
                                                <?php echo e($course->discount ? number_format($course->discount) : number_format($course->price)); ?> تومان
                                            </div>
                                        </div>
                                    <?php else: ?>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="border-bottom pb-3 mb-3">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <span>نام دوره:</span>
                                <span class="font-weight-bold"><?php echo e($course->name); ?></span>
                            </div>
...
<?php echo $__env->make('layouts.layout public.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Analyzoor\resources\views/public/payment/pre-payment.blade.php ENDPATH**/ ?>