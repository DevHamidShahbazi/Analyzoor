<?php $__env->startSection('Header','بارگزاری ها'); ?>
<?php $__env->startSection('files','active'); ?>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card" style="background-color: #353b5000">
                <form role="form" method="post" class="dropzone" action="<?php echo e(route('admin.file.store')); ?>" enctype="multipart/form-data" id="dZUpload">
                    <?php echo csrf_field(); ?>
                    <div class="fallback">
                ...
                <div class="col-sm-12 float-sm-right mb-2">
                    <div style="text-align: initial;" class="m-b-30 text-light">
                        <a href="<?php echo e(route('admin.file.index')); ?>" type="button"  class="btn  btn-primary btn-sm">
                        ...
                        <?php if(!empty($files )): ?>
                            <?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="item<?php echo e($val->id); ?>">
                                    ...
                                    <?php echo $__env->make('admin.file.edit',['key'=>$key], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                                    <td  style="padding:1.5rem 0" class="text-center  text-light ">
                                        <a href="#" data-id="<?php echo e($val->id); ?>" data-route="<?php echo e(route('admin.file.destroy',$val->id)); ?>"  type="submit" style="width: max-content;" class="btn-sm btn-danger btnDelete" ><i style="margin: 0 0 0 5px;" class="fa fa-trash"></i><i style="margin: inherit;">حذف</i></a>
                                    </td>
                                </tr>
...
<?php echo $__env->make('layouts.layout admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Analyzoor\resources\views/admin/file/index.blade.php ENDPATH**/ ?>