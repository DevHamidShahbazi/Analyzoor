<div class="card col-12 border border-secondary border-1 rounded-2 border-opacity-25 mb-2" id="<?php echo e($comment->id); ?>">
    <div class="row p-2">
        <div class="col-lg-12">
...
<?php /**PATH C:\xampp8.1\htdocs\Analyzoor\resources\views/components/public-comment/comment-item.blade.php ENDPATH**/ ?>