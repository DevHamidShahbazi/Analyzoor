                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-center">
                            <img style="border-radius: 15px" class="col-md-6 col-12" src="<?php echo e($article->image); ?>" alt="<?php echo e($article->alt); ?>">
                        </div>
                            ...
                            <div class="row m-0">
                                <?php if($urls->isNotEmpty()): ?>
                                    <?php $__currentLoopData = $urls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-12 my-1" style="text-align: right">
                                            <a class="btn btn-outline-light p-1" download href="<?php echo e($url->url); ?>"><?php echo e($url->name); ?> <i class="fa fa-download"></i>  </a>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                                <?php if($files->isNotEmpty()): ?>
                                        <?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-12 my-1" style="text-align: right">
                                                <a class="btn btn-outline-light p-1" download href="<?php echo e($file->file); ?>"><?php echo e($file->alt); ?> <i class="fa fa-download"></i>  </a>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </div>
