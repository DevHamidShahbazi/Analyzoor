    ...
    <div class="price-product defualt">
        ...
        <?php if($value->discount != null): ?>
            <strike class="d-flex justify-content-end">
                <span style="font-size: medium" class="order-2 text-secondary iranyekan"><?php echo e(number_format($value->price)); ?></span>
...
<?php /**PATH C:\xampp8.1\htdocs\Analyzoor\resources\views/components/public-price/index.blade.php ENDPATH**/ ?>