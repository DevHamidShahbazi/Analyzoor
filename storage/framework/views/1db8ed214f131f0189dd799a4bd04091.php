        ...
        <?php echo $__env->make('alert.form.error', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <form id="myForm" class="form-horizontal" method="POST" action="<?php echo e(route('admin.setting.store')); ?>"  enctype="multipart/form-data" >
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label  class="col-sm-12 control-label"><?php echo e(setting_with_key('course_title')->label); ?></label>
                        <div class="col-sm-6">
                            <input type="text" value="<?php echo e(setting_with_key('course_title')->value); ?>" name="course_title" class="form-control"
                                   placeholder="title">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-sm-12 control-label" >
                                    <span class="badge bg-primary count" id="count">0</span>
                                    <?php echo e(setting_with_key('course_description')->label); ?>

                                </label>
                                <textarea id="description" name="course_description" class="form-control description" rows="3" placeholder="description"><?php echo e(setting_with_key('course_description')->value); ?></textarea>
                            </div>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-12 control-label"><?php echo e(setting_with_key('course_keywords')->label); ?></label>
                        <div class="col-sm-6">
                            <input type="text" value="<?php echo e(setting_with_key('course_keywords')->value); ?>" name="course_keywords" class="form-control"
                                   placeholder="keywords">
                        </div>
                    </div>
                    <hr>
