...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-md-12 ">
        ...
        <?php echo $__env->make('alert.form.error', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <form method="POST" action="<?php echo e(route('admin.episode.store',['course_id'=>$course_id])); ?>"  enctype="multipart/form-data" >
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body mb-1 te">
                    ...
                    <div class="form-group">
                        <div class="col-lg-5">
                            ...
                            <input required type="text" value="<?php echo e(old('time')); ?>" name="time" class="form-control"
...
<?php echo $__env->make('layouts.layout admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Analyzoor\resources\views/admin/course/episode/create.blade.php ENDPATH**/ ?>