            ...
            <div style="height: 100%" class="modal-c-tabs">
                ...
                @include('alert.form.error')
                    ...
                    <div class="tab-pane fade in show active" id="panel17" role="tabpanel">
                        <form method="POST" action="{{ route('admin.article-url.store') }}"  enctype="multipart/form-data" >
                            @csrf
                            ...
                            <div class="modal-body mb-1">
                                ...
                                <div class="md-form mb-2">
                                    ...
                                    <input list="names" required value="{{ old('name')  }}"  dir="rtl" id="name" type="text" class="form-control" name="name" >
                                ...
                                <div class="md-form mb-2">
                                    ...
                                    <input required value="{{ old('url')  }}" id="url" type="text" class="form-control" name="url" >
                                </div>
