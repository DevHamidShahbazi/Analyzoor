<?php $__env->startSection('Header',$article->name.' بارگزاری های مقاله '); ?>
...
<?php $__env->startSection('address'); ?>
    ...
    <li class="breadcrumb-item">
        <a href="<?php echo e(route('admin.article.edit',$article->id)); ?>"> مشاهده مقاله <?php echo e($article->name); ?></a>
    </li>

    <li class="breadcrumb-item"><?php echo e($article->name); ?></li>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card" style="background-color: #353b5000">
                <form role="form" method="post" class="dropzone" action="<?php echo e(route('admin.article-file.store')); ?>" enctype="multipart/form-data" id="dZUpload">
                    <?php echo csrf_field(); ?>
                    <div class="fallback">
                ...
                <div class="col-sm-12 float-sm-right mb-2">
                    <div style="text-align: initial;" class="m-b-30 text-light">
                        <a href="<?php echo e(route('admin.article-file.index',['id'=>$article->id])); ?>" type="button"  class="btn  btn-primary btn-sm">
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover">
                        <tr style="background-color: #343a40;" >
                            ...
                            <th  class="text-center text-light" scope="col">فایل/تصویر</th>
                            ...
                            <?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="item<?php echo e($val->id); ?>">
                                    ...
                                    <td  style="padding:1.5rem 0">
                                        <input  id="input_<?php echo e($val->id); ?>" class="col-8 input_url" type="text"  style="direction: ltr" value="<?php echo e(url($val->file)); ?>">
                                    ...
                                    <td  style="padding:inherit" class="text-center" >
                                        <i>
                                            ...
                                            <?php else: ?>
                                                <img width="100" class="img-thumbnail" src="<?php echo e($val->file); ?>" alt="<?php echo e($val->alt); ?>">
                                            <?php endif; ?>
                                    ...
                                    <?php echo $__env->make('admin.article.file.edit',['key'=>$key], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                                    <td  style="padding:1.5rem 0" class="text-center  text-light ">
                                        <a href="#" data-id="<?php echo e($val->id); ?>" data-route="<?php echo e(route('admin.article-file.destroy',['article_file'=>$val->id])); ?>"  type="submit" style="width: max-content;" class="btn-sm btn-danger btnDelete" ><i style="margin: 0 0 0 5px;" class="fa fa-trash"></i><i style="margin: inherit;">حذف</i></a>
                                    </td>
                                </tr>
...
<?php echo $__env->make('layouts.layout admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Analyzoor\resources\views/admin/article/file/index.blade.php ENDPATH**/ ?>