...
@section('address')
    ...
    <li class="breadcrumb-item">{{ ' سوالات متداول '.$course->name }}</li>
@endsection
        ...
        <div class="col-12">
            <div class="card" style="background-color: #353b5000">
                ...
                <div class="col-sm-12 float-sm-right">
                    ...
                    @include('admin.course.question.create')
                </div>
                <!-- /.card-header -->
                        ...
                        @if(!empty($questions))
                            @foreach($questions as $key=> $val)
                                <tr class="item{{$val->id}}">
                                    ...
                                    <td style="padding:1.5rem 0"  class="text-center font-weight-bold" >{{$val->description}}</td>
                                    ...
                                    @include('admin.course.question.edit')

                                    <td  style="padding:1.5rem 0" class="text-center  text-light ">
                                        <a href="#" data-id="{{ $val->id }}" data-route="{{ route('admin.question.destroy',['question'=>$val->id,'course_id'=>$course_id]) }}"  type="submit" style="width: max-content;" class="btn-sm btn-danger btnDelete" ><i style="margin: 0 0 0 5px;" class="fa fa-trash"></i><i style="margin: inherit;">حذف</i></a>
                                    </td>
                                </tr>
                            @endforeach
                        @endif
