...
<html lang="fa" >
    <head>
        ...
        <link rel="stylesheet" href="/public/css/app-dark.rtl.css?<?php echo e($css); ?>">
    ...
    <div id="app" class="layout-horizontal">
        ...
        <script type="text/javascript" src="/public/js/dark.js?<?php echo e($js); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\fanoram\resources\views/layouts/layout public/index.blade.php ENDPATH**/ ?>