            ...
            <form id="myForm" class="form-horizontal" method="POST" action="<?php echo e(route('admin.setting.store')); ?>"  enctype="multipart/form-data" >
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" value="<?php echo e(setting_with_key('article_title')->value); ?>" name="title" class="form-control"
                                   placeholder="title">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <textarea id="description" name="description" class="form-control description" rows="3" placeholder="description"><?php echo e(setting_with_key('article_description')->value); ?></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" value="<?php echo e(setting_with_key('article_keywords')->value); ?>" name="keywords" class="form-control"
                                   placeholder="keywords">
                        </div>
                    </div>
                    <hr>
