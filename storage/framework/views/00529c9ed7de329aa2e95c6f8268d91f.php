            ...
            <div  class="modal-c-tabs">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade in show active" id="panel17" role="tabpanel">
                        ...
                        <form  method="POST" action="<?php echo e(route('admin.article-url.update',$val->id)); ?>"  enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="modal-body mb-1">
                                <div class="modal-body mb-1">
                                    ...
                                    <div class="md-form mb-2">
                                        ...
                                        <input required value="<?php echo e($val->url); ?>" id="url" type="text" class="form-control" name="url" >
                                    </div>
                                    ...
                                    <div class="md-form mb-2">
                                        ...
                                        <select class="form-control" name="for_download">
                                            <option value="1" <?php echo e($val->for_download == '1'? 'selected':''); ?>>تایید</option>
                                            <option value="0" <?php echo e($val->for_download == '0'? 'selected':''); ?>>عدم تایید</option>
                                        </select>
...
<!-- Modal: edit Form Demo -->
<?php /**PATH C:\xampp\htdocs\Analyzoor\resources\views/admin/article/url/edit.blade.php ENDPATH**/ ?>