...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        var UrlIs_active = "<?php echo e(route('admin.article.is_active')); ?>";
                                ...
                                <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="item<?php echo e($val->id); ?>">
                                        ...
                                        <td style="padding:1.5rem 0"  class="text-center font-weight-bold" >
                                            <a target="_blank" href="<?php echo e(route('article.detail',$val->slug)); ?>">
                                                <?php echo e($val->name); ?>

                                            </a>
                                            <?php echo $__env->make('components.admin-is-active.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></td>
                                        <td style="padding:1.5rem 0"  class="text-center font-weight-bold" ><?php echo e($val->category->name); ?></td>

                                        <td style="padding:1.5rem 0"  class="text-center font-weight-bold" >
                                            <select class="is_active" name="is_active" data-id="<?php echo e($val->id); ?>">
                                                <option class="text-danger" <?php if($val->is_active == 0): ?>  selected  <?php endif; ?> value="0">عدم نمایش</option>
                                                <option class="text-success" <?php if($val->is_active == 1): ?>  selected  <?php endif; ?> value="1">نمایش</option>
                                            </select>
                                        </td>
                                        ...
                                        <td  style="padding:1.5rem 0" class="text-center  text-light ">
                                            ...
                                            <?php echo $__env->make('components.admin-copy-item.index',['route'=>'admin.article.copy'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            ...
                                            <a data-toggle="tooltip" data-placement="top" title="لینک های دانلود" href="<?php echo e(route('admin.article-url.index',['id'=>$val->id ])); ?>"  style="width: max-content;" class="btn-sm btn-warning  col-lg-12">
...
<?php echo $__env->make('layouts.layout admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Analyzoor\resources\views/admin/article/index.blade.php ENDPATH**/ ?>