                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade in show active" id="panel17" role="tabpanel">
                       ...
                       <?php echo $__env->make('alert.form.error', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        ...
                        <form  method="POST" action="<?php echo e(route('admin.file.update',$val->id)); ?>"  enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
<!-- Modal: edit Form Demo -->
<?php /**PATH C:\xampp\htdocs\Analyzoor\resources\views/admin/file/edit.blade.php ENDPATH**/ ?>