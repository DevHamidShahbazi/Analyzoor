            ...
            <div style="height: 100%" class="modal-c-tabs">
                ...
                <?php echo $__env->make('alert.form.error', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    <div class="tab-pane fade in show active" id="panel17" role="tabpanel">
                        <form method="POST" action="<?php echo e(route('admin.url.store')); ?>"  enctype="multipart/form-data" >
                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\Analyzoor\resources\views/admin/url/create.blade.php ENDPATH**/ ?>