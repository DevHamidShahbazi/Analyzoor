<a data-toggle="modal" data-target="#CopyList{{$key}}"  style="width: max-content;" class="btn-sm btn-primary col-lg-12">
...
<div class="modal fade" id="CopyList{{$key}}">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade in show active" id="panel17" role="tabpanel">
                        <form method="POST" action="{{ route($route) }}"  enctype="multipart/form-data" >
                            @csrf
                            <input hidden required value="{{ $val->id  }}" type="text" class="form-control" name="id" >
                            <br>
