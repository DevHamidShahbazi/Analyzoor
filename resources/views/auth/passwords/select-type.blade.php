    ...
    <div class=" login-box" >
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <a href="{{ route('password.request.phone') }}" class="btn btn-block btn-outline-primary font-weight-bold btn-d mt-2">
                    بازیابی با رمز شماره تلفن
                    <i class="fa fa-phone mr-2"></i>
                </a>
                <a href="{{ route('password.request') }}" class="btn btn-block btn-outline-info font-weight-bold mt-2">
