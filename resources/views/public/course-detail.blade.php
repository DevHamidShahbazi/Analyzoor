            ...
            <div class="row">
                ...
                <div class="order-1 col-lg-9">
                    ...
                    <div  class="card shadow rounded-2 mb-2 p-4">
                        ...
                        @include('components.public-questions.index',['data'=>$course->questions()->get()])
                    </div>
                    ...
                    <div class="card shadow rounded-2 mb-2 p-4">
                        <div class="col-12 text-start">
                            ...
                            <hr>
                            @include('components.public-list-chapter.index',['chapters'=>$course->chapters()->get(),'episodes'=>$course->episodes()->get()])
                        </div>
                    </div>
