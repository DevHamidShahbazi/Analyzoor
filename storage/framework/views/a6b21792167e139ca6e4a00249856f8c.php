            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-4 pr-lg-3">
               <div class="row m-0">
                   ...
                   <?php $__currentLoopData = $children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                       <div class="col-md-6">
                           <div class="card mb-2">
                               <a href="<?php echo e(route('child.article.category',$child->slug)); ?>">
                                   <div class="card-content">
                                       <img class="card-img-top img-fluid p-2"
                                            style="border-top-left-radius: 16px;border-top-right-radius: 16px"
                                            src="<?php echo e($child->image); ?>" alt="<?php echo e($child->alt); ?>"/>
                                       <div class="card-body p-1">
                                           <p class="card-title text-center"><?php echo e($child->name); ?></p>
                                       </div>
                                   </div>
                               </a>
                           </div>
