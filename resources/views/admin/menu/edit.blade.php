            ...
            <div {{--style="height: 100%"--}} class="modal-c-tabs">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade in show active" id="panel17" role="tabpanel">
                        ...
                        <form {{--id="SubmitForm"--}} method="POST" action="{{ route('admin.menu.update',$val->id) }}"  enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PATCH') }}
                            <div class="modal-body mb-1">
                                <div class="modal-body mb-1">
                                    ...
                                    <div class="md-form mb-2">
                                        ...
                                        <input value="{{ $val->sort  }}" id="sort" type="number" class="form-control" name="sort" >
                                    </div>
